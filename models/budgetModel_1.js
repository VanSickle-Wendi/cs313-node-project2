...
//
//   var sql = "SELECT creditor, due, total_owed FROM monthly_bills JOIN amount ON monthly_bills.id = amount.m_bill";
//
//   pool.query(sql, function (err, db_results) {
//
//      if (err) {
...
//};
//
//function addAmountsInDb(callback) {
//
//   var sql3 = 'SELECT SUM(due) FROM amount';
//
